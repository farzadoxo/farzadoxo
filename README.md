...
<div id="skills">
  ...
  | ----------- | ----------- | ----------- |
  | ![programming](https://skillicons.dev/icons?i=py,cs,dotnet) | ![other](https://skillicons.dev/icons?i=wordpress,sqlite,bots,md) | ![apps](https://skillicons.dev/icons?i=git,github,discord,obsidian,replit,vscode,visualstudio,linux)
  </div>
...
<div id="social-status">
  ...
  <a href="https://linkedin.com/in/f-ebrahimi"><img src="https://github.com/farzadoxo/farzadoxo/blob/master/media/linkedin.PNG" width="50%"></a>
  </div>
</div>
